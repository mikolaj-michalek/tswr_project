...
from ldm.systems.car.dynamics.kicajka3_params import Kicajka3Parameters
from ldm.utils.bspline import BSpline


class CasadiKicajka3TireModel(CasadiBaseTireModel):
    def __init__(self, n, n_up, *args, **kwargs) -> None:
        super().__init__()
        self.front_tire_model_parameters = Kicajka3Parameters(n, n_up)
        self.rear_tire_model_parameters = Kicajka3Parameters(n, n_up)

        N = 64
        self.torch_bspline = BSpline(n=n + 2, d=3, num_T_pts=N, name="kicajka3")
...
if __name__ == "__main__":
    ...
    n = 10
    n_up = 9
    torch_model = Kicajka3TireModel(n=n, n_up=n_up)
    casadi_model = CasadiKicajka3TireModel(n=n, n_up=n_up)
    ...
    tire_force_func = ca.Function('kicajka3_tire_force', [sa_sym, sr_sym], [fx_sym, fy_sym])
    ...
    print("CasADi vs Torch Kicajka3 numerical check passed.")
