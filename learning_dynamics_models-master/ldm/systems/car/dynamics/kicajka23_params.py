...
Kicajka23ParamsList = ['x_norm', 'y_norm', 'x_scale', 'y_scale', 'cps_x', 'cps_y']
Kicajka23Params = collections.namedtuple('PacejkaParams', Kicajka23ParamsList, defaults=[] * len(Kicajka23ParamsList))


class Kicajka23Parameters(torch.nn.Module):
    def __init__(self, n_train, n_up) -> None:
        super(Kicajka23Parameters, self).__init__()
