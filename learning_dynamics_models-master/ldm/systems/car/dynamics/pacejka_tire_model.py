...
class PacejkaTireModel(BaseTireModel):
    def __init__(self, randomize_init=0., *args, **kwargs) -> None:
        super().__init__()
        self.front_tire_model_parameters = PacejkaParameters(randomize_init=randomize_init)
        self.rear_tire_model_parameters = PacejkaParameters(randomize_init=randomize_init)
